...
class DB_HOSTEL
{
    ...
    public function __construct()
    {
        ...
        try {
            $this->_pdo = new PDO("sqlsrv:Server=" . Config::get('mssql_hostel/host') . ";Database=". Config::get('mssql_hostel/db'), Config::get('mssql_hostel/username'), Config::get('mssql_hostel/password'));
    ...
    */
    public static function getInstance()
    {
        ...
        if (!isset(self::$_instance)) {
            self::$_instance = new DB_HOSTEL();// no previous instance exists, callon the DB object and establish database connection
        }
