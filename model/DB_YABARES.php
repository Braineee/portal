...
class DB_YABARES
{
    ...
    public function __construct()
    {
        ...
        try {
            $this->_pdo = new PDO("sqlsrv:Server=" . Config::get('mssql_yabares/host') . ";Database=". Config::get('mssql_yabares/db'), Config::get('mssql_yabares/username'), Config::get('mssql_yabares/password'));
    ...
    */
    public static function getInstance()
    {
        ...
        if (!isset(self::$_instance)) {
            self::$_instance = new DB_YABARES();// no previous instance exists, callon the DB object and establish database connection
        }
