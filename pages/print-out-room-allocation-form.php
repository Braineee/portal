             ...
             <div class="print"   style="">
                ...
                <div class="panel-body">
                    <table style="width:800px; border: 0px;" align="center" id="printDiv">
                        ...
                        <tr>
                            <td align="center" style="border: 0px; padding-left:50px;">
                                <h3 align="center"><b class="emph" >ROOM ALLOCATION FORM</b></h3>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td style="border: 0px;">
                                <table style="border: 0px;">
                                    ...
                                    <tr>
                                        <td style="border: 0px; padding-right:20px;"><li class="bio_print">NAME OF SPONSOR:</td>
                                        <td style="border: 0px; padding-top:20px;"><b class="bio_print">------------------------------------------------------------</b></li></td>													
                                    </tr>
                                    <tr>
                                        <td style="border: 0px; padding-right:20px;"><li class="bio_print">ADDRESS:</td>
                                        <td style="border: 0px;"><b class="bio_print"><?php echo $_SESSION['student_details']->address;?></b></li></td>													
                                    </tr>
                                </table>
                            </td>
                    ...
                    <table style="width:800px; border: 0px; margin-bottom:30px;" align="center">
                        ...
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">GUARANTOR'S NAME & SIGNATURE: 
                                ----------------------------------------------------------------------------------------------------------------------------------<br>
                                <span class="bio_print"><small><b>(NB: Guarantor must be a YCT Snr Staff i.e Contediss 14 /compcass 8 & above or HOD of applicant's department)</b></small></span>
                            </td>
                        </tr>
                            
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">DEPARTMENT: --------------------------------------------------------------------------------------</li></td>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">ARE YOU AFFLICTED BY ANY DISEASE OF DISABILITY (Yes/No): -----------------------------------------</li></td>
                        </tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">IF YES, STATE DETAILS:<br><br>
                                ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</li>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;">   
                                <blockquote class="emph"><b>PLEDGE:</b></blockquote>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                I pledge to be of good behavior and to observe the <b>Rules and Regulations</b> in the Hall of residence. I also pledge my commitment to the provisions in the College of Students'
                                Handbook which in part (a) forbids sub-letting of my Hostel allocation(Article 10:4).
                            </li>
                            </td>
                        </tr>2
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                I hereby sign an undertaking never to habour anybody illegally or sell my room. Otherwise, if caught I stand being expelled.
                            </li>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                In addition I will not habour a non-yabatech person in my room.
                            </li>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px; padding-top:10px;"><li class="bio_print">SIGNATURE OF STUDENT & DATE: ----------------------------------------------------------------------------------------</li></td>
                        <tr> 
                        <tr>
                            <td style="border: 0px; padding-right:20px;">   
                                <blockquote class="emph"><b>FOR OFFICIAL USE ONLY</b></blockquote>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px; padding-top:10px;"><li class="bio_print">
                                HALL OF RESIDENCE:&ensp;&ensp;<b><?php echo $_SESSION['hostel_allocation_details']->Hostelname; ?></b>&ensp;&ensp;ROOM NO.:&ensp;&ensp;<b><?php echo $_SESSION['hostel_allocation_details']->Room; ?></b>&ensp;&ensp;
                            </li></td>
                        <tr> 
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                NO. OF STUDENTS IN THE ROOM:----------------------------------------------------------------------------------------
                            </li></td>
                        <tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                SIGNATURE OF HALL WELFARE OFFICER:----------------------------------------------------------------------------------
                            </li></td>
                        <tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                SIGNATURE OF HALL WARDER:-------------------------------------------------------------------------------------------
                            </li></td>
                        <tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                REMARK BY STUDENT WITHIN 24HOURS:<br><br>
                                ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                            </li></td>
                        <tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                NAME OF PORTER ON DUTY:--------------------------------------------------------------------------------SIGNATURE & DATE:------------------------------------
                            </li></td>
                        <tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
                                NAME OF HALL SUPERVISOR:--------------------------------------------------------------------------------SIGNATURE & DATE:------------------------------------
                            </li></td>
                        <tr>
                        <tr>
                            <td style="border: 0px; padding-right:20px;"><li class="bio_print">
