            ...
            <section>
              <div class="container py-3">
                <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;"
                  ...
                  <a href="?pg=pay-schoolfees" class="text-green">
                  <div class="row">
                      ...
                      <div class="col-md-8 col-sm-8">
                        <div class="card-block px-3 py-3">
                          <p class="card-text">
                            <b>Pay school fees</b><br>
                            Make school fees payment here.
                          </p>
                        </div>
                      </div>
                  </div>
                      ...
                      <div class="col-md-8 col-sm-8">
                        <div class="card-block px-3 py-3">
                          <p class="card-text">
                            ...
                            Print your payment history here.
                          </p>
                        </div>
                      </div>
                  </div>
                ...
                <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;"
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8 col-sm-8">
                        <div class="card-block px-3 py-3">
                          <p class="card-text">
                            <b>School fees receipts</b><br>
                            Print your school fees receipt here.
                          </p>
                        </div>
                      </div>
                  </div>
